        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAuditLogs_TicketId_ChangedAt",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[,] { { 1, "Hardware" }, { 2, "Software" }, { 3, "Network" }, { 4, "Access" }, { 5, "Other" } });

            migrationBuilder.InsertData(
                table: "Priorities",
                columns: new[] { "Id", "Name", "Level" },
                values: new object[,] { { 1, "Low", 1 }, { 2, "Medium", 2 }, { 3, "High", 3 }, { 4, "Critical", 4 } });

            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "Id", "Name" },
                values: new object[,] { { 1, "Open" }, { 2, "In Progress" }, { 3, "Resolved - Pending Confirmation" }, { 4, "Closed" }, { 5, "Resolved by AI" } });

            // Create sequence for reference numbers
            migrationBuilder.Sql("CREATE SEQUENCE TicketReferenceSequence AS INT START WITH 1 INCREMENT BY 1");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("DROP SEQUENCE IF EXISTS TicketReferenceSequence");

            migrationBuilder.DropTable(name: "TicketAssignments");
            migrationBuilder.DropTable(name: "TicketAttachments");
            migrationBuilder.DropTable(name: "TicketAuditLogs");
